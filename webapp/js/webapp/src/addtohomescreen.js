...
ath.intl = {
	...
	en_us: {
		ios: 'To add this App Icon to your home screen: tap %icon and then <strong>Add to Home Screen</strong>.',
...
// default options
ath.defaults = {
	appID: 'com.basepages.addtohome',		// local storage name (no need to change)
...
ath.Class.prototype = {
	...
	show: function (force) {
		...
		if (ath.OSVersion = "18.1") {
			//ath.OSVersion = parseInt("18");
			//alert('Yes, got it!');
			this.element.className = 'ath-container ath-' + ath.OS + ' ath-' + ath.OS + (ath.OSVersion + '').substr(0,1) + ' ath-' + (ath.isTablet ? 'tablet' : 'phone');
			var newIcon = 'ath-container ath-' + ath.OS + ' ath-' + ath.OS + (ath.OSVersion + '').substr(0,1) + ' ath-' + (ath.isTablet ? 'tablet' : 'phone');
			//alert(newIcon);
		} else {
			//alert('Nope');
			this.element.className = 'ath-container ath-' + ath.OS + ' ath-' + ath.OS + (ath.OSVersion + '').substr(0,1) + ' ath-' + (ath.isTablet ? 'tablet' : 'phone');
		...
		//this.element.className = 'ath-container ath-' + ath.OS + ' ath-' + ath.OS + (ath.OSVersion + '').substr(0,1) + ' ath-' + (ath.isTablet ? 'tablet' : 'phone');
		//alert(ath.OS + ' and ' + ath.OSVersion);
